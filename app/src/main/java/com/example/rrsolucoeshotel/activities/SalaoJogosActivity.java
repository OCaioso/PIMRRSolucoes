...
public class SalaoJogosActivity extends AppCompatActivity {
    ...
    private final String TITULO_SJOGOS = "Serviços do Salão de Jogos";
    ...
    private void CarregarDadosParaLista() {
        ...
        AdapterProdutos adapterSJogos = new AdapterProdutos(listaSalaojogos);
        ...
        recyclerProdutos.setAdapter( adapterSJogos );
    }
